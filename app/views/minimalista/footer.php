 ...
 <script type="text/javascript" src="<?= ASSETS ?>minimalista/js/responsee.js"></script>
 <script type="text/javascript" src="<?= ASSETS ?>minimalista/js/jquery.events.touch.js"></script>
 <script type="text/javascript" src="<?= ASSETS ?>minimalista/owl-carousel/owl.carousel.js"></script>
 <script type="text/javascript" src="<?= ASSETS ?>minimalista/js/template-scripts.js"></script>
 </body>
